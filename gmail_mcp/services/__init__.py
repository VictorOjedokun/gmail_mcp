...
from ..models import (
    Message, Thread, Label, Draft, Profile, AttachmentData,
    MessagePart, MessageHeader, SendEmailRequest, SearchEmailsRequest,
    EmailListRequest, ModifyLabelsRequest, CreateLabelRequest,
    ForwardEmailRequest, CreateDraftRequest, ThreadListRequest,
    EmailListResponse, ThreadListResponse, LabelListResponse, DraftListResponse
)
...
class GmailService(BaseModel):
    ...
    def __init__(self, token_info: TokenInfo):
        ...
        self.credentials = Credentials(token=token_info.token)
    ...
    def _extract_message_content(self, payload: Dict[str, Any]) -> tuple[str, str, List[AttachmentData]]:
    ...
    async def list_messages(self, request: EmailListRequest) -> EmailListResponse:
    ...
    async def search_messages(self, request: SearchEmailsRequest) -> EmailListResponse:
    ...
    async def list_drafts(self, max_results: int = 10, page_token: Optional[str] = None) -> DraftListResponse:
        """List draft emails.
