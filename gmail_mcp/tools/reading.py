...
def register_reading_tools(mcp: FastMCP):
    ...
    async def get_emails(
        ...
        try:
            ...
            # Get emails
            response = await gmail_service.list_messages(email_request)
    ...
    async def get_email_by_id(
        ...
        Args:
            ...
            format: Email format (MINIMAL, FULL, RAW, METADATA)
        ...
        try:
            ...
            # GmailService is injected with the access token already configured
            message = await gmail_service.get_message(email_id, format)
    ...
    async def search_emails(
        ...
        try:
            ...
            response = await gmail_service.search_messages(search_request)
    ...
    @mcp.tool()
    async def get_labels(gmail_service: GmailService = Depends(get_gmail_service)) -> str:
    ...
    @mcp.tool()
    async def get_profile(gmail_service: GmailService = Depends(get_gmail_service)) -> str:
